...
//Нажимаем на кнопку + Бренд
        ...
        $(byXpath("//elma-form-control/elma-type-string/div/input")).sendKeys("auto_test_a3"); // воткнуть переменную на имя бренд
...
//Ждем 5 секунд м нажимаем на созданный элемент
        $(byText("auto_test_a3")).shouldBe(enabled,ofSeconds(5));
        $(byText("auto_test_a3")).click();
